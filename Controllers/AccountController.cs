...
namespace ExpenseTracker.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult UserDashboard()
        {
            ...
            var currentBudget = _dbContext.Budgets.FirstOrDefault(b => b.UserId == userId);
            ...
            {
                // Return the view without a model (assuming the view handles the case when currentBudget is null)
                return View();
            }
        }
